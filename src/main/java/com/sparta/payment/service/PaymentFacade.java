...
public class PaymentFacade {
    ...
    public PaymentDto.PaymentReadyResponse preparePayment(PaymentDto.OrderRequest request) {
        ...
        ProductDto.ProductResponse productResponse = productService.getProduct(request.getProductId());
        Long calculatedAmount = productResponse.getPrice() * request.getQuantity();
